...
Route::middleware(['auth:customer','customer_status'])->group(function () {
 ...
 // Chat pelanggan dengan Admin (bukan CS)
    Route::get('dashboard/customer/chat-admin', [ChatController::class, 'chatAdmin'])->name('customer.chat.admin');
    Route::get('/chat-admin/messages', [ChatController::class, 'getAdminMessages'])->name('chat.admin.messages');
    Route::post('/chat-admin/send', [ChatController::class, 'sendToAdmin'])->name('chat.admin.send');
    Route::post('/chat-admin/mark-read/{userId}', [ChatController::class, 'markReadAdmin'])->name('chat.admin.markRead');
